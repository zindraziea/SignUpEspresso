...
class LoginTestSuite {
    ...
    fun TC2001_LoginFailWithEmptyEmailAndPassword() {
        ...
        Login.verifyErrorMessage("enter a valid email address", "between 4 and 10 alphanumeric characters")
    }

    @Test
    fun TC2002_LoginFailWithInvalidEmail() {
        Login.enterInformationAndLoginWithHint("email@email", "a112233")
        Login.verifyErrorMessage("enter a valid email address", null)
    }

    @Test
    fun TC2003_LoginFailWithEmptyPassword() {
        Login.enterInformationAndLogin("email@email.com", "")
        Login.verifyErrorMessage(null, "between 4 and 10 alphanumeric characters")
    }
    ...
    fun TC2006_LoginFailAuthentication() {
        ...
        Login.verifyErrorMessage(null, "enter a valid email address or password")
    }
